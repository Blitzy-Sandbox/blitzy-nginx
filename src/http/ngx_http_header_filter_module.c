...
ngx_http_header_filter(ngx_http_request_t *r)
{
    u_char                    *p;
    size_t                     len;
    ngx_str_t                  host, *status_line, reason;
    ngx_buf_t                 *b;
    ...
    if (r->headers_out.status_line.len) {
        ...
        /* 204 and 304 set header flags independent of the reason lookup */
        ...
        /* the status registry is the single source of truth for reasons */
